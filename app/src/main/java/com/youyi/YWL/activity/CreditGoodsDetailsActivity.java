...
public class CreditGoodsDetailsActivity extends BaseActivity {
            ...
            case DATA_URL:
                if (Constanst.success_net_code.equals(code)) {
                    ...
                    if ("0".equals(status)) {
                        ...
                        Picasso.with(this).load(dataMap.get("img") + "").placeholder(R.mipmap.img_loading).error(R.mipmap.img_load_error).into(iv_goods);//商品图片
    ...
    @OnClick({R.id.tvBack, R.id.tv_exchange})
