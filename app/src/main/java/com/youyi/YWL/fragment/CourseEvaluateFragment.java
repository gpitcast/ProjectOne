...
import com.youyi.YWL.adapter.CourseEvaluateFragmentAdapter;
...
public class CourseEvaluateFragment extends BaseFragment {
    ...
    private CourseEvaluateFragmentAdapter courseEvaluateFragmentAdapter;
    ...
    private void initRecyclerView() {
        ...
        courseEvaluateFragmentAdapter = new CourseEvaluateFragmentAdapter(getActivity());
        xRecyclerView.setAdapter(courseEvaluateFragmentAdapter);
        View headView1 = LayoutInflater.from(getActivity()).inflate(R.layout.layout_course_evaluate_head, null);
