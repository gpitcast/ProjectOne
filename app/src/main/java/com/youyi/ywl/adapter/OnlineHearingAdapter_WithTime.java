...
public class OnlineHearingAdapter_WithTime extends RecyclerView.Adapter {
    private Context context;
    private List<HashMap<String, Object>> dataList;
    private RecyclerViewOnItemClickListener itemClickListener;

    public OnlineHearingAdapter_WithTime(Context context, List<HashMap<String, Object>> dataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.item_online_hearing_with_time, null), itemClickListener);
    }
