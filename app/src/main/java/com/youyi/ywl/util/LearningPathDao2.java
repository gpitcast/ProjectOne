...
public class LearningPathDao2 {
    ...
    public LearningPathDao2(Context context, String table_name, String db_name) {
    ...
    public List<HashMap<String, Object>> select() {
        ...
        Cursor cursor = rd.query(true, TABLE_NAME, new String[]{ID, URL, TITLE, DATE,MILLIS}, MILLIS + ">?",
    ...
    public class LearningPathHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            //创建表格
            String sql = "create table if not exists " + TABLE_NAME + " (" + "id integer primary key autoincrement," + ID + " text," + URL + " text," + TITLE + " text,"
