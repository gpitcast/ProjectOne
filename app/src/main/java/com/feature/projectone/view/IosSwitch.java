...
import com.feature.projectone.util.GestureUtils;
...
public class IosSwitch extends View implements View.OnClickListener {
    ...
    private final int BORDER_WIDTH = 0;//边框宽度

    private int mBasePlaneColor = Color.parseColor("#219735");//底盘颜色,布局描边颜色
    private int mOpenSlotColor = Color.parseColor("#219735");//开启时手柄滑动槽的颜色
    private int mOffSlotColor = Color.parseColor("#bebebe");//关闭时手柄滑动槽的颜色
