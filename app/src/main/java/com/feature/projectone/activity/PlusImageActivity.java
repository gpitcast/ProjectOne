...
import com.feature.projectone.adapter.ViewPagerAdapter;
...
public class PlusImageActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgList = getIntent().getStringArrayListExtra(Constanst.IMG_LIST);
        mPosition = getIntent().getIntExtra(Constanst.POSITION, 0);
        initView();
    }
...
//    }
    ...
    private void back() {
        ...
        intent.putStringArrayListExtra(Constanst.IMG_LIST, imgList);
        setResult(Constanst.RESULT_CODE_VIEW_IMG, intent);
        finish();
    }
