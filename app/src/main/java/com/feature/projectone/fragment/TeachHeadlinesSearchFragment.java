 ...
 * 资讯头条搜索的 教育头条fragment
 */

public class TeachHeadlinesSearchFragment extends BaseFragment {
    ...
    public TeachHeadlinesSearchFragment() {
    }

    @SuppressLint("ValidFragment")
    public TeachHeadlinesSearchFragment(HashMap<String, Object> map) {
        this.typeMap = map;
    }
