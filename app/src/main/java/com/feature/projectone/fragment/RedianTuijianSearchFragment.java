 ...
 * 资讯头条搜索的 热点推荐fragment
 */

public class RedianTuijianSearchFragment extends BaseFragment {
    ...
    public RedianTuijianSearchFragment() {
    }

    @SuppressLint("ValidFragment")
    public RedianTuijianSearchFragment(HashMap<String, Object> map) {
        this.typeMap = map;
    }
