 ...
 * 资讯头条搜索的 教育咨询fragment
 */

public class TeachConsultSearchFragment extends BaseFragment {
    ...
    public TeachConsultSearchFragment() {
    }

    @SuppressLint("ValidFragment")
    public TeachConsultSearchFragment(HashMap<String, Object> map) {
        this.typeMap = map;
    }
